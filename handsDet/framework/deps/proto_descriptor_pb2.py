...
# source: handsDet/framework/deps/proto_descriptor.proto
...
_FIELDDESCRIPTORPROTO_TYPE = _descriptor.EnumDescriptor(
  name='Type',
  full_name='handsDet.FieldDescriptorProto.Type',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_FIELDDESCRIPTORPROTO = _descriptor.Descriptor(
  ...
  full_name='handsDet.FieldDescriptorProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
FieldDescriptorProto = _reflection.GeneratedProtocolMessageType('FieldDescriptorProto', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.framework.deps.proto_descriptor_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.FieldDescriptorProto)
  ))
