...
# source: handsDet/framework/formats/image_format.proto
...
_IMAGEFORMAT_FORMAT = _descriptor.EnumDescriptor(
  name='Format',
  full_name='handsDet.ImageFormat.Format',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_IMAGEFORMAT = _descriptor.Descriptor(
  name='ImageFormat',
  full_name='handsDet.ImageFormat',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
ImageFormat = _reflection.GeneratedProtocolMessageType('ImageFormat', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.framework.formats.image_format_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.ImageFormat)
  ))
