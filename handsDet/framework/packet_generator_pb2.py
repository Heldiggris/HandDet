...
# source: handsDet/framework/packet_generator.proto
...
_PACKETGENERATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.PacketGeneratorOptions',
  filename=None,
  file=DESCRIPTOR,
...
_PACKETGENERATORCONFIG = _descriptor.Descriptor(
  ...
  full_name='handsDet.PacketGeneratorConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='packet_generator', full_name='handsDet.PacketGeneratorConfig.packet_generator', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='input_side_packet', full_name='handsDet.PacketGeneratorConfig.input_side_packet', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='external_input', full_name='handsDet.PacketGeneratorConfig.external_input', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output_side_packet', full_name='handsDet.PacketGeneratorConfig.output_side_packet', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='external_output', full_name='handsDet.PacketGeneratorConfig.external_output', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='options', full_name='handsDet.PacketGeneratorConfig.options', index=5,
...
PacketGeneratorOptions = _reflection.GeneratedProtocolMessageType('PacketGeneratorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.framework.packet_generator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.PacketGeneratorOptions)
  ))
...
PacketGeneratorConfig = _reflection.GeneratedProtocolMessageType('PacketGeneratorConfig', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.framework.packet_generator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.PacketGeneratorConfig)
  ))
