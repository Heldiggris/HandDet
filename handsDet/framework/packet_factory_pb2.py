...
# source: handsDet/framework/packet_factory.proto
...
_PACKETFACTORYOPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.PacketFactoryOptions',
  filename=None,
  file=DESCRIPTOR,
...
_PACKETFACTORYCONFIG = _descriptor.Descriptor(
  ...
  full_name='handsDet.PacketFactoryConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='packet_factory', full_name='handsDet.PacketFactoryConfig.packet_factory', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='output_side_packet', full_name='handsDet.PacketFactoryConfig.output_side_packet', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='external_output', full_name='handsDet.PacketFactoryConfig.external_output', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='options', full_name='handsDet.PacketFactoryConfig.options', index=3,
...
_PACKETMANAGERCONFIG = _descriptor.Descriptor(
  ...
  full_name='handsDet.PacketManagerConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='packet', full_name='handsDet.PacketManagerConfig.packet', index=0,
...
PacketFactoryOptions = _reflection.GeneratedProtocolMessageType('PacketFactoryOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.framework.packet_factory_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.PacketFactoryOptions)
  ))
...
PacketFactoryConfig = _reflection.GeneratedProtocolMessageType('PacketFactoryConfig', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.framework.packet_factory_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.PacketFactoryConfig)
  ))
...
PacketManagerConfig = _reflection.GeneratedProtocolMessageType('PacketManagerConfig', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.framework.packet_factory_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.PacketManagerConfig)
  ))
