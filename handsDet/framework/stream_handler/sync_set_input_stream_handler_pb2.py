...
# source: handsDet/framework/stream_handler/sync_set_input_stream_handler.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/framework/stream_handler/sync_set_input_stream_handler.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\nFhandsDet/framework/stream_handler/sync_set_input_stream_handler.proto\x12\thandsDet\x1a+handsDet/framework/handsDet_options.proto\"\xe1\x01\n SyncSetInputStreamHandlerOptions\x12\x45\n\x08sync_set\x18\x01 \x03(\x0b\x32\x33.handsDet.SyncSetInputStreamHandlerOptions.SyncSet\x1a\x1c\n\x07SyncSet\x12\x11\n\ttag_index\x18\x01 \x03(\t2X\n\x03\x65xt\x12\x1b.handsDet.MediaPipeOptions\x18\xd1\xa2\xa6J \x01(\x0b\x32+.handsDet.SyncSetInputStreamHandlerOptions')
  ,
...
_SYNCSETINPUTSTREAMHANDLEROPTIONS_SYNCSET = _descriptor.Descriptor(
  name='SyncSet',
  full_name='handsDet.SyncSetInputStreamHandlerOptions.SyncSet',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tag_index', full_name='handsDet.SyncSetInputStreamHandlerOptions.SyncSet.tag_index', index=0,
...
_SYNCSETINPUTSTREAMHANDLEROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.SyncSetInputStreamHandlerOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='sync_set', full_name='handsDet.SyncSetInputStreamHandlerOptions.sync_set', index=0,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.SyncSetInputStreamHandlerOptions.ext', index=0,
...
SyncSetInputStreamHandlerOptions = _reflection.GeneratedProtocolMessageType('SyncSetInputStreamHandlerOptions', (_message.Message,), dict(
  ...
  SyncSet = _reflection.GeneratedProtocolMessageType('SyncSet', (_message.Message,), dict(
    ...
    __module__ = 'handsDet.framework.stream_handler.sync_set_input_stream_handler_pb2'
    # @@protoc_insertion_point(class_scope:handsDet.SyncSetInputStreamHandlerOptions.SyncSet)
    ))
  ,
  DESCRIPTOR = _SYNCSETINPUTSTREAMHANDLEROPTIONS,
  __module__ = 'handsDet.framework.stream_handler.sync_set_input_stream_handler_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.SyncSetInputStreamHandlerOptions)
  ))
...
handsDet_dot_framework_dot_handsDet__options__pb2.MediaPipeOptions.RegisterExtension(_SYNCSETINPUTSTREAMHANDLEROPTIONS.extensions_by_name['ext'])
