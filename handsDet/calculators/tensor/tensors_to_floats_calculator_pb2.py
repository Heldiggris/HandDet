...
# source: handsDet/calculators/tensor/tensors_to_floats_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/tensor/tensors_to_floats_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n?handsDet/calculators/tensor/tensors_to_floats_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\xf5\x01\n TensorsToFloatsCalculatorOptions\x12P\n\nactivation\x18\x01 \x01(\x0e\x32\x36.handsDet.TensorsToFloatsCalculatorOptions.Activation:\x04NONE\"#\n\nActivation\x12\x08\n\x04NONE\x10\x00\x12\x0b\n\x07SIGMOID\x10\x01\x32Z\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xeb\xc2\xe5\xa3\x01 \x01(\x0b\x32+.handsDet.TensorsToFloatsCalculatorOptions')
  ,
...
_TENSORSTOFLOATSCALCULATOROPTIONS_ACTIVATION = _descriptor.EnumDescriptor(
  name='Activation',
  full_name='handsDet.TensorsToFloatsCalculatorOptions.Activation',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_TENSORSTOFLOATSCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.TensorsToFloatsCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='activation', full_name='handsDet.TensorsToFloatsCalculatorOptions.activation', index=0,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.TensorsToFloatsCalculatorOptions.ext', index=0,
...
TensorsToFloatsCalculatorOptions = _reflection.GeneratedProtocolMessageType('TensorsToFloatsCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.tensor.tensors_to_floats_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.TensorsToFloatsCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_TENSORSTOFLOATSCALCULATOROPTIONS.extensions_by_name['ext'])
