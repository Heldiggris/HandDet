...
# source: handsDet/calculators/tensor/image_to_tensor_calculator.proto
...
from handsDet.gpu import gpu_origin_pb2 as handsDet_dot_gpu_dot_gpu__origin__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/tensor/image_to_tensor_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n=handsDet/calculators/tensor/image_to_tensor_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\x1a\x1ehandsDet/gpu/gpu_origin.proto\"\xa0\x05\n\x1eImageToTensorCalculatorOptions\x12\x1b\n\x13output_tensor_width\x18\x01 \x01(\x05\x12\x1c\n\x14output_tensor_height\x18\x02 \x01(\x05\x12\x19\n\x11keep_aspect_ratio\x18\x03 \x01(\x08\x12Y\n\x19output_tensor_float_range\x18\x04 \x01(\x0b\x32\x34.handsDet.ImageToTensorCalculatorOptions.FloatRangeH\x00\x12U\n\x17output_tensor_int_range\x18\x07 \x01(\x0b\x32\x32.handsDet.ImageToTensorCalculatorOptions.IntRangeH\x00\x12-\n\ngpu_origin\x18\x05 \x01(\x0e\x32\x19.handsDet.GpuOrigin.Mode\x12I\n\x0b\x62order_mode\x18\x06 \x01(\x0e\x32\x34.handsDet.ImageToTensorCalculatorOptions.BorderMode\x1a&\n\nFloatRange\x12\x0b\n\x03min\x18\x01 \x01(\x02\x12\x0b\n\x03max\x18\x02 \x01(\x02\x1a$\n\x08IntRange\x12\x0b\n\x03min\x18\x01 \x01(\x03\x12\x0b\n\x03max\x18\x02 \x01(\x03\"K\n\nBorderMode\x12\x16\n\x12\x42ORDER_UNSPECIFIED\x10\x00\x12\x0f\n\x0b\x42ORDER_ZERO\x10\x01\x12\x14\n\x10\x42ORDER_REPLICATE\x10\x02\x32X\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xd3\xea\xb7\x9f\x01 \x01(\x0b\x32).handsDet.ImageToTensorCalculatorOptionsB\x07\n\x05range')
  ,
  dependencies=[handsDet_dot_framework_dot_calculator__pb2.DESCRIPTOR,handsDet_dot_gpu_dot_gpu__origin__pb2.DESCRIPTOR,])



_IMAGETOTENSORCALCULATOROPTIONS_BORDERMODE = _descriptor.EnumDescriptor(
  name='BorderMode',
  full_name='handsDet.ImageToTensorCalculatorOptions.BorderMode',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_IMAGETOTENSORCALCULATOROPTIONS_FLOATRANGE = _descriptor.Descriptor(
  name='FloatRange',
  full_name='handsDet.ImageToTensorCalculatorOptions.FloatRange',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min', full_name='handsDet.ImageToTensorCalculatorOptions.FloatRange.min', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='max', full_name='handsDet.ImageToTensorCalculatorOptions.FloatRange.max', index=1,
...
_IMAGETOTENSORCALCULATOROPTIONS_INTRANGE = _descriptor.Descriptor(
  name='IntRange',
  full_name='handsDet.ImageToTensorCalculatorOptions.IntRange',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min', full_name='handsDet.ImageToTensorCalculatorOptions.IntRange.min', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max', full_name='handsDet.ImageToTensorCalculatorOptions.IntRange.max', index=1,
...
_IMAGETOTENSORCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.ImageToTensorCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='output_tensor_width', full_name='handsDet.ImageToTensorCalculatorOptions.output_tensor_width', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output_tensor_height', full_name='handsDet.ImageToTensorCalculatorOptions.output_tensor_height', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keep_aspect_ratio', full_name='handsDet.ImageToTensorCalculatorOptions.keep_aspect_ratio', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output_tensor_float_range', full_name='handsDet.ImageToTensorCalculatorOptions.output_tensor_float_range', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output_tensor_int_range', full_name='handsDet.ImageToTensorCalculatorOptions.output_tensor_int_range', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='gpu_origin', full_name='handsDet.ImageToTensorCalculatorOptions.gpu_origin', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='border_mode', full_name='handsDet.ImageToTensorCalculatorOptions.border_mode', index=6,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.ImageToTensorCalculatorOptions.ext', index=0,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='range', full_name='handsDet.ImageToTensorCalculatorOptions.range',
...
_IMAGETOTENSORCALCULATOROPTIONS.fields_by_name['gpu_origin'].enum_type = handsDet_dot_gpu_dot_gpu__origin__pb2._GPUORIGIN_MODE
...
ImageToTensorCalculatorOptions = _reflection.GeneratedProtocolMessageType('ImageToTensorCalculatorOptions', (_message.Message,), dict(
  ...
  FloatRange = _reflection.GeneratedProtocolMessageType('FloatRange', (_message.Message,), dict(
    ...
    __module__ = 'handsDet.calculators.tensor.image_to_tensor_calculator_pb2'
    # @@protoc_insertion_point(class_scope:handsDet.ImageToTensorCalculatorOptions.FloatRange)
    ))
  ,
  ...
  IntRange = _reflection.GeneratedProtocolMessageType('IntRange', (_message.Message,), dict(
    ...
    __module__ = 'handsDet.calculators.tensor.image_to_tensor_calculator_pb2'
    # @@protoc_insertion_point(class_scope:handsDet.ImageToTensorCalculatorOptions.IntRange)
    ))
  ,
  DESCRIPTOR = _IMAGETOTENSORCALCULATOROPTIONS,
  __module__ = 'handsDet.calculators.tensor.image_to_tensor_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.ImageToTensorCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_IMAGETOTENSORCALCULATOROPTIONS.extensions_by_name['ext'])
