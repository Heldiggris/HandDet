...
# source: handsDet/calculators/tensor/landmarks_to_tensor_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/tensor/landmarks_to_tensor_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\nAhandsDet/calculators/tensor/landmarks_to_tensor_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\xa7\x02\n\"LandmarksToTensorCalculatorOptions\x12K\n\nattributes\x18\x01 \x03(\x0e\x32\x37.handsDet.LandmarksToTensorCalculatorOptions.Attribute\x12\x16\n\x07\x66latten\x18\x02 \x01(\x08:\x05\x66\x61lse\">\n\tAttribute\x12\x05\n\x01X\x10\x00\x12\x05\n\x01Y\x10\x01\x12\x05\n\x01Z\x10\x02\x12\x0e\n\nVISIBILITY\x10\x03\x12\x0c\n\x08PRESENCE\x10\x04\x32\\\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xfb\xa6\xa1\xbc\x01 \x01(\x0b\x32-.handsDet.LandmarksToTensorCalculatorOptions')
  ,
...
_LANDMARKSTOTENSORCALCULATOROPTIONS_ATTRIBUTE = _descriptor.EnumDescriptor(
  name='Attribute',
  full_name='handsDet.LandmarksToTensorCalculatorOptions.Attribute',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_LANDMARKSTOTENSORCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.LandmarksToTensorCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='attributes', full_name='handsDet.LandmarksToTensorCalculatorOptions.attributes', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='flatten', full_name='handsDet.LandmarksToTensorCalculatorOptions.flatten', index=1,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.LandmarksToTensorCalculatorOptions.ext', index=0,
...
LandmarksToTensorCalculatorOptions = _reflection.GeneratedProtocolMessageType('LandmarksToTensorCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.tensor.landmarks_to_tensor_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.LandmarksToTensorCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_LANDMARKSTOTENSORCALCULATOROPTIONS.extensions_by_name['ext'])
