...
# source: handsDet/calculators/tensor/tensor_converter_calculator.proto
...
_TENSORCONVERTERCALCULATOROPTIONS_TENSORFLOATRANGE = _descriptor.Descriptor(
  ...
  full_name='handsDet.TensorConverterCalculatorOptions.TensorFloatRange',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min', full_name='handsDet.TensorConverterCalculatorOptions.TensorFloatRange.min', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='max', full_name='handsDet.TensorConverterCalculatorOptions.TensorFloatRange.max', index=1,
...
_TENSORCONVERTERCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.TensorConverterCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='zero_center', full_name='handsDet.TensorConverterCalculatorOptions.zero_center', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_custom_normalization', full_name='handsDet.TensorConverterCalculatorOptions.use_custom_normalization', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='custom_div', full_name='handsDet.TensorConverterCalculatorOptions.custom_div', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='custom_sub', full_name='handsDet.TensorConverterCalculatorOptions.custom_sub', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flip_vertically', full_name='handsDet.TensorConverterCalculatorOptions.flip_vertically', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_num_channels', full_name='handsDet.TensorConverterCalculatorOptions.max_num_channels', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='row_major_matrix', full_name='handsDet.TensorConverterCalculatorOptions.row_major_matrix', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_quantized_tensors', full_name='handsDet.TensorConverterCalculatorOptions.use_quantized_tensors', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output_tensor_float_range', full_name='handsDet.TensorConverterCalculatorOptions.output_tensor_float_range', index=8,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.TensorConverterCalculatorOptions.ext', index=0,
...
TensorConverterCalculatorOptions = _reflection.GeneratedProtocolMessageType('TensorConverterCalculatorOptions', (_message.Message,), dict(
  ...
  TensorFloatRange = _reflection.GeneratedProtocolMessageType('TensorFloatRange', (_message.Message,), dict(
    ...
    __module__ = 'handsDet.calculators.tensor.tensor_converter_calculator_pb2'
    # @@protoc_insertion_point(class_scope:handsDet.TensorConverterCalculatorOptions.TensorFloatRange)
    ))
  ,
  DESCRIPTOR = _TENSORCONVERTERCALCULATOROPTIONS,
  __module__ = 'handsDet.calculators.tensor.tensor_converter_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.TensorConverterCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_TENSORCONVERTERCALCULATOROPTIONS.extensions_by_name['ext'])
