...
# source: handsDet/calculators/util/landmark_projection_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/util/landmark_projection_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n?handsDet/calculators/util/landmark_projection_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\xa3\x01\n#LandmarkProjectionCalculatorOptions\x12\x1e\n\x0fignore_rotation\x18\x01 \x01(\x08:\x05\x66\x61lse2\\\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xf4\xf8\xca} \x01(\x0b\x32..handsDet.LandmarkProjectionCalculatorOptions')
  ,
...
_LANDMARKPROJECTIONCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.LandmarkProjectionCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='ignore_rotation', full_name='handsDet.LandmarkProjectionCalculatorOptions.ignore_rotation', index=0,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.LandmarkProjectionCalculatorOptions.ext', index=0,
...
LandmarkProjectionCalculatorOptions = _reflection.GeneratedProtocolMessageType('LandmarkProjectionCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.util.landmark_projection_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.LandmarkProjectionCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_LANDMARKPROJECTIONCALCULATOROPTIONS.extensions_by_name['ext'])
