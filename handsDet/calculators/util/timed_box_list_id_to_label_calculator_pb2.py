...
# source: handsDet/calculators/util/timed_box_list_id_to_label_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/util/timed_box_list_id_to_label_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\nFhandsDet/calculators/util/timed_box_list_id_to_label_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\xa2\x01\n&TimedBoxListIdToLabelCalculatorOptions\x12\x16\n\x0elabel_map_path\x18\x01 \x01(\t2`\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xe6\xa1\xfa\x8d\x01 \x01(\x0b\x32\x31.handsDet.TimedBoxListIdToLabelCalculatorOptions')
  ,
...
_TIMEDBOXLISTIDTOLABELCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.TimedBoxListIdToLabelCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='label_map_path', full_name='handsDet.TimedBoxListIdToLabelCalculatorOptions.label_map_path', index=0,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.TimedBoxListIdToLabelCalculatorOptions.ext', index=0,
...
TimedBoxListIdToLabelCalculatorOptions = _reflection.GeneratedProtocolMessageType('TimedBoxListIdToLabelCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.util.timed_box_list_id_to_label_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.TimedBoxListIdToLabelCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_TIMEDBOXLISTIDTOLABELCALCULATOROPTIONS.extensions_by_name['ext'])
