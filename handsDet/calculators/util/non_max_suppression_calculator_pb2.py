...
# source: handsDet/calculators/util/non_max_suppression_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/util/non_max_suppression_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n?handsDet/calculators/util/non_max_suppression_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\xf5\x04\n\"NonMaxSuppressionCalculatorOptions\x12 \n\x15num_detection_streams\x18\x01 \x01(\x05:\x01\x31\x12\x1e\n\x12max_num_detections\x18\x02 \x01(\x05:\x02-1\x12\x1f\n\x13min_score_threshold\x18\x06 \x01(\x02:\x02-1\x12$\n\x19min_suppression_threshold\x18\x03 \x01(\x02:\x01\x31\x12X\n\x0coverlap_type\x18\x04 \x01(\x0e\x32\x39.handsDet.NonMaxSuppressionCalculatorOptions.OverlapType:\x07JACCARD\x12\x1f\n\x17return_empty_detections\x18\x05 \x01(\x08\x12V\n\talgorithm\x18\x07 \x01(\x0e\x32:.handsDet.NonMaxSuppressionCalculatorOptions.NmsAlgorithm:\x07\x44\x45\x46\x41ULT\"k\n\x0bOverlapType\x12\x1c\n\x18UNSPECIFIED_OVERLAP_TYPE\x10\x00\x12\x0b\n\x07JACCARD\x10\x01\x12\x14\n\x10MODIFIED_JACCARD\x10\x02\x12\x1b\n\x17INTERSECTION_OVER_UNION\x10\x03\")\n\x0cNmsAlgorithm\x12\x0b\n\x07\x44\x45\x46\x41ULT\x10\x00\x12\x0c\n\x08WEIGHTED\x10\x01\x32[\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xbc\xa8\xb4\x1a \x01(\x0b\x32-.handsDet.NonMaxSuppressionCalculatorOptions')
  ,
...
_NONMAXSUPPRESSIONCALCULATOROPTIONS_OVERLAPTYPE = _descriptor.EnumDescriptor(
  name='OverlapType',
  full_name='handsDet.NonMaxSuppressionCalculatorOptions.OverlapType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_NONMAXSUPPRESSIONCALCULATOROPTIONS_NMSALGORITHM = _descriptor.EnumDescriptor(
  name='NmsAlgorithm',
  full_name='handsDet.NonMaxSuppressionCalculatorOptions.NmsAlgorithm',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_NONMAXSUPPRESSIONCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.NonMaxSuppressionCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='num_detection_streams', full_name='handsDet.NonMaxSuppressionCalculatorOptions.num_detection_streams', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='max_num_detections', full_name='handsDet.NonMaxSuppressionCalculatorOptions.max_num_detections', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='min_score_threshold', full_name='handsDet.NonMaxSuppressionCalculatorOptions.min_score_threshold', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='min_suppression_threshold', full_name='handsDet.NonMaxSuppressionCalculatorOptions.min_suppression_threshold', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='overlap_type', full_name='handsDet.NonMaxSuppressionCalculatorOptions.overlap_type', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='return_empty_detections', full_name='handsDet.NonMaxSuppressionCalculatorOptions.return_empty_detections', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='algorithm', full_name='handsDet.NonMaxSuppressionCalculatorOptions.algorithm', index=6,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.NonMaxSuppressionCalculatorOptions.ext', index=0,
...
NonMaxSuppressionCalculatorOptions = _reflection.GeneratedProtocolMessageType('NonMaxSuppressionCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.util.non_max_suppression_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.NonMaxSuppressionCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_NONMAXSUPPRESSIONCALCULATOROPTIONS.extensions_by_name['ext'])
