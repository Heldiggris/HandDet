...
# source: handsDet/calculators/util/landmarks_refinement_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/util/landmarks_refinement_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n@handsDet/calculators/util/landmarks_refinement_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\xdd\x05\n$LandmarksRefinementCalculatorOptions\x12N\n\nrefinement\x18\x01 \x03(\x0b\x32:.handsDet.LandmarksRefinementCalculatorOptions.Refinement\x1a\x11\n\x0fZRefinementNone\x1a\x11\n\x0fZRefinementCopy\x1a\x37\n\x18ZRefinementAssignAverage\x12\x1b\n\x13indexes_for_average\x18\x01 \x03(\x05\x1a\xab\x02\n\x0bZRefinement\x12O\n\x04none\x18\x01 \x01(\x0b\x32?.handsDet.LandmarksRefinementCalculatorOptions.ZRefinementNoneH\x00\x12O\n\x04\x63opy\x18\x02 \x01(\x0b\x32?.handsDet.LandmarksRefinementCalculatorOptions.ZRefinementCopyH\x00\x12\x62\n\x0e\x61ssign_average\x18\x03 \x01(\x0b\x32H.handsDet.LandmarksRefinementCalculatorOptions.ZRefinementAssignAverageH\x00\x42\x16\n\x14z_refinement_options\x1ax\n\nRefinement\x12\x17\n\x0findexes_mapping\x18\x01 \x03(\x05\x12Q\n\x0cz_refinement\x18\x02 \x01(\x0b\x32;.handsDet.LandmarksRefinementCalculatorOptions.ZRefinement2^\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xa2\x9c\x8e\xb6\x01 \x01(\x0b\x32/.handsDet.LandmarksRefinementCalculatorOptions')
  ,
...
_LANDMARKSREFINEMENTCALCULATOROPTIONS_ZREFINEMENTNONE = _descriptor.Descriptor(
  ...
  full_name='handsDet.LandmarksRefinementCalculatorOptions.ZRefinementNone',
  filename=None,
  file=DESCRIPTOR,
...
_LANDMARKSREFINEMENTCALCULATOROPTIONS_ZREFINEMENTCOPY = _descriptor.Descriptor(
  ...
  full_name='handsDet.LandmarksRefinementCalculatorOptions.ZRefinementCopy',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_LANDMARKSREFINEMENTCALCULATOROPTIONS_ZREFINEMENTASSIGNAVERAGE = _descriptor.Descriptor(
  ...
  full_name='handsDet.LandmarksRefinementCalculatorOptions.ZRefinementAssignAverage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='indexes_for_average', full_name='handsDet.LandmarksRefinementCalculatorOptions.ZRefinementAssignAverage.indexes_for_average', index=0,
...
_LANDMARKSREFINEMENTCALCULATOROPTIONS_ZREFINEMENT = _descriptor.Descriptor(
  name='ZRefinement',
  full_name='handsDet.LandmarksRefinementCalculatorOptions.ZRefinement',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='none', full_name='handsDet.LandmarksRefinementCalculatorOptions.ZRefinement.none', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='copy', full_name='handsDet.LandmarksRefinementCalculatorOptions.ZRefinement.copy', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='assign_average', full_name='handsDet.LandmarksRefinementCalculatorOptions.ZRefinement.assign_average', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='z_refinement_options', full_name='handsDet.LandmarksRefinementCalculatorOptions.ZRefinement.z_refinement_options',
...
_LANDMARKSREFINEMENTCALCULATOROPTIONS_REFINEMENT = _descriptor.Descriptor(
  name='Refinement',
  full_name='handsDet.LandmarksRefinementCalculatorOptions.Refinement',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='indexes_mapping', full_name='handsDet.LandmarksRefinementCalculatorOptions.Refinement.indexes_mapping', index=0,
      number=1, type=5, cpp_type=1, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='z_refinement', full_name='handsDet.LandmarksRefinementCalculatorOptions.Refinement.z_refinement', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LANDMARKSREFINEMENTCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.LandmarksRefinementCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='refinement', full_name='handsDet.LandmarksRefinementCalculatorOptions.refinement', index=0,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.LandmarksRefinementCalculatorOptions.ext', index=0,
...
LandmarksRefinementCalculatorOptions = _reflection.GeneratedProtocolMessageType('LandmarksRefinementCalculatorOptions', (_message.Message,), dict(
  ...
  ZRefinementNone = _reflection.GeneratedProtocolMessageType('ZRefinementNone', (_message.Message,), dict(
    ...
    __module__ = 'handsDet.calculators.util.landmarks_refinement_calculator_pb2'
    # @@protoc_insertion_point(class_scope:handsDet.LandmarksRefinementCalculatorOptions.ZRefinementNone)
    ))
  ,
  ...
  ZRefinementCopy = _reflection.GeneratedProtocolMessageType('ZRefinementCopy', (_message.Message,), dict(
    ...
    __module__ = 'handsDet.calculators.util.landmarks_refinement_calculator_pb2'
    # @@protoc_insertion_point(class_scope:handsDet.LandmarksRefinementCalculatorOptions.ZRefinementCopy)
    ))
  ,
  ...
  ZRefinementAssignAverage = _reflection.GeneratedProtocolMessageType('ZRefinementAssignAverage', (_message.Message,), dict(
    ...
    __module__ = 'handsDet.calculators.util.landmarks_refinement_calculator_pb2'
    # @@protoc_insertion_point(class_scope:handsDet.LandmarksRefinementCalculatorOptions.ZRefinementAssignAverage)
    ))
  ,
  ...
  ZRefinement = _reflection.GeneratedProtocolMessageType('ZRefinement', (_message.Message,), dict(
    ...
    __module__ = 'handsDet.calculators.util.landmarks_refinement_calculator_pb2'
    # @@protoc_insertion_point(class_scope:handsDet.LandmarksRefinementCalculatorOptions.ZRefinement)
    ))
  ,
  ...
  Refinement = _reflection.GeneratedProtocolMessageType('Refinement', (_message.Message,), dict(
    ...
    __module__ = 'handsDet.calculators.util.landmarks_refinement_calculator_pb2'
    # @@protoc_insertion_point(class_scope:handsDet.LandmarksRefinementCalculatorOptions.Refinement)
    ))
  ,
  DESCRIPTOR = _LANDMARKSREFINEMENTCALCULATOROPTIONS,
  __module__ = 'handsDet.calculators.util.landmarks_refinement_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.LandmarksRefinementCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_LANDMARKSREFINEMENTCALCULATOROPTIONS.extensions_by_name['ext'])
