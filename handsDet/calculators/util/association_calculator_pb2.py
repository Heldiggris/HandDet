...
# source: handsDet/calculators/util/association_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/util/association_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n7handsDet/calculators/util/association_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\x9b\x01\n\x1c\x41ssociationCalculatorOptions\x12#\n\x18min_similarity_threshold\x18\x01 \x01(\x02:\x01\x31\x32V\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xef\xa4\x98\x83\x01 \x01(\x0b\x32\'.handsDet.AssociationCalculatorOptions')
  ,
...
_ASSOCIATIONCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.AssociationCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_similarity_threshold', full_name='handsDet.AssociationCalculatorOptions.min_similarity_threshold', index=0,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.AssociationCalculatorOptions.ext', index=0,
...
AssociationCalculatorOptions = _reflection.GeneratedProtocolMessageType('AssociationCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.util.association_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.AssociationCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_ASSOCIATIONCALCULATOROPTIONS.extensions_by_name['ext'])
