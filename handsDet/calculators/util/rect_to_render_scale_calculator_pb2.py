...
# source: handsDet/calculators/util/rect_to_render_scale_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/util/rect_to_render_scale_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n@handsDet/calculators/util/rect_to_render_scale_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\x9c\x01\n\"RectToRenderScaleCalculatorOptions\x12\x18\n\nmultiplier\x18\x01 \x01(\x02:\x04\x30.012\\\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xf1\xe5\xe5\x8e\x01 \x01(\x0b\x32-.handsDet.RectToRenderScaleCalculatorOptions')
  ,
...
_RECTTORENDERSCALECALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.RectToRenderScaleCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='multiplier', full_name='handsDet.RectToRenderScaleCalculatorOptions.multiplier', index=0,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.RectToRenderScaleCalculatorOptions.ext', index=0,
...
RectToRenderScaleCalculatorOptions = _reflection.GeneratedProtocolMessageType('RectToRenderScaleCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.util.rect_to_render_scale_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.RectToRenderScaleCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_RECTTORENDERSCALECALCULATOROPTIONS.extensions_by_name['ext'])
