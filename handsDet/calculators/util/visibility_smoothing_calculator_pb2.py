...
# source: handsDet/calculators/util/visibility_smoothing_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/util/visibility_smoothing_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n@handsDet/calculators/util/visibility_smoothing_calculator.proto\x12\thandsDet\x1a,handsDet/framework/calculator_options.proto\"\xf2\x02\n$VisibilitySmoothingCalculatorOptions\x12M\n\tno_filter\x18\x01 \x01(\x0b\x32\x38.handsDet.VisibilitySmoothingCalculatorOptions.NoFilterH\x00\x12X\n\x0flow_pass_filter\x18\x02 \x01(\x0b\x32=.handsDet.VisibilitySmoothingCalculatorOptions.LowPassFilterH\x00\x1a\n\n\x08NoFilter\x1a#\n\rLowPassFilter\x12\x12\n\x05\x61lpha\x18\x01 \x01(\x02:\x03\x30.12^\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xf6\xa7\xe1\xab\x01 \x01(\x0b\x32/.handsDet.VisibilitySmoothingCalculatorOptionsB\x10\n\x0e\x66ilter_options')
  ,
...
_VISIBILITYSMOOTHINGCALCULATOROPTIONS_NOFILTER = _descriptor.Descriptor(
  name='NoFilter',
  full_name='handsDet.VisibilitySmoothingCalculatorOptions.NoFilter',
  filename=None,
  file=DESCRIPTOR,
...
_VISIBILITYSMOOTHINGCALCULATOROPTIONS_LOWPASSFILTER = _descriptor.Descriptor(
  name='LowPassFilter',
  full_name='handsDet.VisibilitySmoothingCalculatorOptions.LowPassFilter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='alpha', full_name='handsDet.VisibilitySmoothingCalculatorOptions.LowPassFilter.alpha', index=0,
...
_VISIBILITYSMOOTHINGCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.VisibilitySmoothingCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='no_filter', full_name='handsDet.VisibilitySmoothingCalculatorOptions.no_filter', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='low_pass_filter', full_name='handsDet.VisibilitySmoothingCalculatorOptions.low_pass_filter', index=1,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.VisibilitySmoothingCalculatorOptions.ext', index=0,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='filter_options', full_name='handsDet.VisibilitySmoothingCalculatorOptions.filter_options',
...
VisibilitySmoothingCalculatorOptions = _reflection.GeneratedProtocolMessageType('VisibilitySmoothingCalculatorOptions', (_message.Message,), dict(
  ...
  NoFilter = _reflection.GeneratedProtocolMessageType('NoFilter', (_message.Message,), dict(
    ...
    __module__ = 'handsDet.calculators.util.visibility_smoothing_calculator_pb2'
    # @@protoc_insertion_point(class_scope:handsDet.VisibilitySmoothingCalculatorOptions.NoFilter)
    ))
  ,
  ...
  LowPassFilter = _reflection.GeneratedProtocolMessageType('LowPassFilter', (_message.Message,), dict(
    ...
    __module__ = 'handsDet.calculators.util.visibility_smoothing_calculator_pb2'
    # @@protoc_insertion_point(class_scope:handsDet.VisibilitySmoothingCalculatorOptions.LowPassFilter)
    ))
  ,
  DESCRIPTOR = _VISIBILITYSMOOTHINGCALCULATOROPTIONS,
  __module__ = 'handsDet.calculators.util.visibility_smoothing_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.VisibilitySmoothingCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_VISIBILITYSMOOTHINGCALCULATOROPTIONS.extensions_by_name['ext'])
