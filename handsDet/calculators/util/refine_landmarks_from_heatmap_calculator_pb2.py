...
# source: handsDet/calculators/util/refine_landmarks_from_heatmap_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/util/refine_landmarks_from_heatmap_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\nIhandsDet/calculators/util/refine_landmarks_from_heatmap_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\x95\x02\n+RefineLandmarksFromHeatmapCalculatorOptions\x12\x16\n\x0bkernel_size\x18\x01 \x01(\x05:\x01\x39\x12%\n\x18min_confidence_to_refine\x18\x02 \x01(\x02:\x03\x30.5\x12\x1e\n\x0frefine_presence\x18\x03 \x01(\x08:\x05\x66\x61lse\x12 \n\x11refine_visibility\x18\x04 \x01(\x08:\x05\x66\x61lse2e\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xb5\xf5\xdf\xac\x01 \x01(\x0b\x32\x36.handsDet.RefineLandmarksFromHeatmapCalculatorOptions')
  ,
...
_REFINELANDMARKSFROMHEATMAPCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.RefineLandmarksFromHeatmapCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='kernel_size', full_name='handsDet.RefineLandmarksFromHeatmapCalculatorOptions.kernel_size', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='min_confidence_to_refine', full_name='handsDet.RefineLandmarksFromHeatmapCalculatorOptions.min_confidence_to_refine', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='refine_presence', full_name='handsDet.RefineLandmarksFromHeatmapCalculatorOptions.refine_presence', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='refine_visibility', full_name='handsDet.RefineLandmarksFromHeatmapCalculatorOptions.refine_visibility', index=3,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.RefineLandmarksFromHeatmapCalculatorOptions.ext', index=0,
...
RefineLandmarksFromHeatmapCalculatorOptions = _reflection.GeneratedProtocolMessageType('RefineLandmarksFromHeatmapCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.util.refine_landmarks_from_heatmap_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.RefineLandmarksFromHeatmapCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_REFINELANDMARKSFROMHEATMAPCALCULATOROPTIONS.extensions_by_name['ext'])
