...
# source: handsDet/calculators/internal/callback_packet_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/internal/callback_packet_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n?handsDet/calculators/internal/callback_packet_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\x99\x02\n\x1f\x43\x61llbackPacketCalculatorOptions\x12\x44\n\x04type\x18\x01 \x01(\x0e\x32\x36.handsDet.CallbackPacketCalculatorOptions.PointerType\x12\x0f\n\x07pointer\x18\x02 \x01(\x0c\"E\n\x0bPointerType\x12\x0b\n\x07UNKNOWN\x10\x00\x12\x11\n\rVECTOR_PACKET\x10\x01\x12\x16\n\x12POST_STREAM_PACKET\x10\x02\x32X\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xeb\xc7\xa4u \x01(\x0b\x32*.handsDet.CallbackPacketCalculatorOptions')
  ,
...
_CALLBACKPACKETCALCULATOROPTIONS_POINTERTYPE = _descriptor.EnumDescriptor(
  name='PointerType',
  full_name='handsDet.CallbackPacketCalculatorOptions.PointerType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_CALLBACKPACKETCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.CallbackPacketCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='handsDet.CallbackPacketCalculatorOptions.type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='pointer', full_name='handsDet.CallbackPacketCalculatorOptions.pointer', index=1,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.CallbackPacketCalculatorOptions.ext', index=0,
...
CallbackPacketCalculatorOptions = _reflection.GeneratedProtocolMessageType('CallbackPacketCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.internal.callback_packet_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.CallbackPacketCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_CALLBACKPACKETCALCULATOROPTIONS.extensions_by_name['ext'])
