...
# source: handsDet/calculators/image/image_cropping_calculator.proto
...
_IMAGECROPPINGCALCULATOROPTIONS_BORDERMODE = _descriptor.EnumDescriptor(
  name='BorderMode',
  full_name='handsDet.ImageCroppingCalculatorOptions.BorderMode',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_IMAGECROPPINGCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.ImageCroppingCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='width', full_name='handsDet.ImageCroppingCalculatorOptions.width', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='height', full_name='handsDet.ImageCroppingCalculatorOptions.height', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rotation', full_name='handsDet.ImageCroppingCalculatorOptions.rotation', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='norm_width', full_name='handsDet.ImageCroppingCalculatorOptions.norm_width', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='norm_height', full_name='handsDet.ImageCroppingCalculatorOptions.norm_height', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='norm_center_x', full_name='handsDet.ImageCroppingCalculatorOptions.norm_center_x', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='norm_center_y', full_name='handsDet.ImageCroppingCalculatorOptions.norm_center_y', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='border_mode', full_name='handsDet.ImageCroppingCalculatorOptions.border_mode', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output_max_width', full_name='handsDet.ImageCroppingCalculatorOptions.output_max_width', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output_max_height', full_name='handsDet.ImageCroppingCalculatorOptions.output_max_height', index=9,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.ImageCroppingCalculatorOptions.ext', index=0,
...
ImageCroppingCalculatorOptions = _reflection.GeneratedProtocolMessageType('ImageCroppingCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.image.image_cropping_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.ImageCroppingCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_IMAGECROPPINGCALCULATOROPTIONS.extensions_by_name['ext'])
