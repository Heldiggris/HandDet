...
# source: handsDet/calculators/image/set_alpha_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/image/set_alpha_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n6handsDet/calculators/image/set_alpha_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\x88\x01\n\x19SetAlphaCalculatorOptions\x12\x17\n\x0b\x61lpha_value\x18\x01 \x01(\x11:\x02-12R\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xa7\xe1\xd4w \x01(\x0b\x32$.handsDet.SetAlphaCalculatorOptions')
  ,
...
_SETALPHACALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.SetAlphaCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='alpha_value', full_name='handsDet.SetAlphaCalculatorOptions.alpha_value', index=0,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.SetAlphaCalculatorOptions.ext', index=0,
...
SetAlphaCalculatorOptions = _reflection.GeneratedProtocolMessageType('SetAlphaCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.image.set_alpha_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.SetAlphaCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_SETALPHACALCULATOROPTIONS.extensions_by_name['ext'])
