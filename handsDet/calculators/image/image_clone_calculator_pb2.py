...
# source: handsDet/calculators/image/image_clone_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/image/image_clone_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n8handsDet/calculators/image/image_clone_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\x92\x01\n\x1bImageCloneCalculatorOptions\x12\x1c\n\routput_on_gpu\x18\x01 \x01(\x08:\x05\x66\x61lse2U\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xc6\xe6\xe0\xb1\x01 \x01(\x0b\x32&.handsDet.ImageCloneCalculatorOptions')
  ,
...
_IMAGECLONECALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.ImageCloneCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='output_on_gpu', full_name='handsDet.ImageCloneCalculatorOptions.output_on_gpu', index=0,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.ImageCloneCalculatorOptions.ext', index=0,
...
ImageCloneCalculatorOptions = _reflection.GeneratedProtocolMessageType('ImageCloneCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.image.image_clone_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.ImageCloneCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_IMAGECLONECALCULATOROPTIONS.extensions_by_name['ext'])
