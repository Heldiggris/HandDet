...
# source: handsDet/calculators/core/constant_side_packet_calculator.proto
...
from handsDet.framework.formats import classification_pb2 as handsDet_dot_framework_dot_formats_dot_classification__pb2
from handsDet.framework.formats import landmark_pb2 as handsDet_dot_framework_dot_formats_dot_landmark__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/core/constant_side_packet_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=_b('\242\002\thandsDet'),
  serialized_pb=_b('\n@handsDet/calculators/core/constant_side_packet_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\x1a\x30handsDet/framework/formats/classification.proto\x1a*handsDet/framework/formats/landmark.proto\"\xe5\x03\n#ConstantSidePacketCalculatorOptions\x12Q\n\x06packet\x18\x01 \x03(\x0b\x32\x41.handsDet.ConstantSidePacketCalculatorOptions.ConstantSidePacket\x1a\x8b\x02\n\x12\x43onstantSidePacket\x12\x13\n\tint_value\x18\x01 \x01(\x05H\x00\x12\x15\n\x0b\x66loat_value\x18\x02 \x01(\x02H\x00\x12\x14\n\nbool_value\x18\x03 \x01(\x08H\x00\x12\x16\n\x0cstring_value\x18\x04 \x01(\tH\x00\x12\x16\n\x0cuint64_value\x18\x05 \x01(\x04H\x00\x12\x42\n\x19\x63lassification_list_value\x18\x06 \x01(\x0b\x32\x1d.handsDet.ClassificationListH\x00\x12\x36\n\x13landmark_list_value\x18\x07 \x01(\x0b\x32\x17.handsDet.LandmarkListH\x00\x42\x07\n\x05value2]\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\x85\xaa\xee\x8a\x01 \x01(\x0b\x32..handsDet.ConstantSidePacketCalculatorOptionsB\x0c\xa2\x02\thandsDet')
  ,
  dependencies=[handsDet_dot_framework_dot_calculator__pb2.DESCRIPTOR,handsDet_dot_framework_dot_formats_dot_classification__pb2.DESCRIPTOR,handsDet_dot_framework_dot_formats_dot_landmark__pb2.DESCRIPTOR,])
...
_CONSTANTSIDEPACKETCALCULATOROPTIONS_CONSTANTSIDEPACKET = _descriptor.Descriptor(
  ...
  full_name='handsDet.ConstantSidePacketCalculatorOptions.ConstantSidePacket',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='int_value', full_name='handsDet.ConstantSidePacketCalculatorOptions.ConstantSidePacket.int_value', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='float_value', full_name='handsDet.ConstantSidePacketCalculatorOptions.ConstantSidePacket.float_value', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bool_value', full_name='handsDet.ConstantSidePacketCalculatorOptions.ConstantSidePacket.bool_value', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='string_value', full_name='handsDet.ConstantSidePacketCalculatorOptions.ConstantSidePacket.string_value', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='uint64_value', full_name='handsDet.ConstantSidePacketCalculatorOptions.ConstantSidePacket.uint64_value', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='classification_list_value', full_name='handsDet.ConstantSidePacketCalculatorOptions.ConstantSidePacket.classification_list_value', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='landmark_list_value', full_name='handsDet.ConstantSidePacketCalculatorOptions.ConstantSidePacket.landmark_list_value', index=6,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='value', full_name='handsDet.ConstantSidePacketCalculatorOptions.ConstantSidePacket.value',
...
_CONSTANTSIDEPACKETCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.ConstantSidePacketCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='packet', full_name='handsDet.ConstantSidePacketCalculatorOptions.packet', index=0,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.ConstantSidePacketCalculatorOptions.ext', index=0,
...
_CONSTANTSIDEPACKETCALCULATOROPTIONS_CONSTANTSIDEPACKET.fields_by_name['classification_list_value'].message_type = handsDet_dot_framework_dot_formats_dot_classification__pb2._CLASSIFICATIONLIST
_CONSTANTSIDEPACKETCALCULATOROPTIONS_CONSTANTSIDEPACKET.fields_by_name['landmark_list_value'].message_type = handsDet_dot_framework_dot_formats_dot_landmark__pb2._LANDMARKLIST
...
ConstantSidePacketCalculatorOptions = _reflection.GeneratedProtocolMessageType('ConstantSidePacketCalculatorOptions', (_message.Message,), dict(
  ...
  ConstantSidePacket = _reflection.GeneratedProtocolMessageType('ConstantSidePacket', (_message.Message,), dict(
    ...
    __module__ = 'handsDet.calculators.core.constant_side_packet_calculator_pb2'
    # @@protoc_insertion_point(class_scope:handsDet.ConstantSidePacketCalculatorOptions.ConstantSidePacket)
    ))
  ,
  DESCRIPTOR = _CONSTANTSIDEPACKETCALCULATOROPTIONS,
  __module__ = 'handsDet.calculators.core.constant_side_packet_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.ConstantSidePacketCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_CONSTANTSIDEPACKETCALCULATOROPTIONS.extensions_by_name['ext'])
