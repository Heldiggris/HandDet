...
# source: handsDet/calculators/core/packet_resampler_calculator.proto
...
_PACKETRESAMPLERCALCULATOROPTIONS_OUTPUTHEADER = _descriptor.EnumDescriptor(
  name='OutputHeader',
  full_name='handsDet.PacketResamplerCalculatorOptions.OutputHeader',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_PACKETRESAMPLERCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.PacketResamplerCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='frame_rate', full_name='handsDet.PacketResamplerCalculatorOptions.frame_rate', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='output_header', full_name='handsDet.PacketResamplerCalculatorOptions.output_header', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flush_last_packet', full_name='handsDet.PacketResamplerCalculatorOptions.flush_last_packet', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='jitter', full_name='handsDet.PacketResamplerCalculatorOptions.jitter', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='jitter_with_reflection', full_name='handsDet.PacketResamplerCalculatorOptions.jitter_with_reflection', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reproducible_sampling', full_name='handsDet.PacketResamplerCalculatorOptions.reproducible_sampling', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='base_timestamp', full_name='handsDet.PacketResamplerCalculatorOptions.base_timestamp', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='start_time', full_name='handsDet.PacketResamplerCalculatorOptions.start_time', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='end_time', full_name='handsDet.PacketResamplerCalculatorOptions.end_time', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='round_limits', full_name='handsDet.PacketResamplerCalculatorOptions.round_limits', index=9,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.PacketResamplerCalculatorOptions.ext', index=0,
...
PacketResamplerCalculatorOptions = _reflection.GeneratedProtocolMessageType('PacketResamplerCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.core.packet_resampler_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.PacketResamplerCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_PACKETRESAMPLERCALCULATOROPTIONS.extensions_by_name['ext'])
