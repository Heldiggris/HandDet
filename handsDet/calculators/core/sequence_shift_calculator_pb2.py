...
# source: handsDet/calculators/core/sequence_shift_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/core/sequence_shift_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=_b('\242\002\thandsDet'),
  serialized_pb=_b('\n:handsDet/calculators/core/sequence_shift_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\x94\x01\n\x1eSequenceShiftCalculatorOptions\x12\x19\n\rpacket_offset\x18\x01 \x01(\x05:\x02-12W\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\x87\xba\xa9\x33 \x01(\x0b\x32).handsDet.SequenceShiftCalculatorOptionsB\x0c\xa2\x02\thandsDet')
  ,
...
_SEQUENCESHIFTCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.SequenceShiftCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='packet_offset', full_name='handsDet.SequenceShiftCalculatorOptions.packet_offset', index=0,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.SequenceShiftCalculatorOptions.ext', index=0,
...
SequenceShiftCalculatorOptions = _reflection.GeneratedProtocolMessageType('SequenceShiftCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.core.sequence_shift_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.SequenceShiftCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_SEQUENCESHIFTCALCULATOROPTIONS.extensions_by_name['ext'])
