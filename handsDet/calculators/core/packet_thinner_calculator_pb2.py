...
# source: handsDet/calculators/core/packet_thinner_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/core/packet_thinner_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=_b('\242\002\thandsDet'),
  serialized_pb=_b('\n:handsDet/calculators/core/packet_thinner_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\xf3\x02\n\x1ePacketThinnerCalculatorOptions\x12R\n\x0cthinner_type\x18\x01 \x01(\x0e\x32\x35.handsDet.PacketThinnerCalculatorOptions.ThinnerType:\x05\x41SYNC\x12\x11\n\x06period\x18\x02 \x01(\x03:\x01\x31\x12\x12\n\nstart_time\x18\x03 \x01(\x03\x12\x10\n\x08\x65nd_time\x18\x04 \x01(\x03\x12$\n\x16sync_output_timestamps\x18\x05 \x01(\x08:\x04true\x12 \n\x11update_frame_rate\x18\x06 \x01(\x08:\x05\x66\x61lse\"\"\n\x0bThinnerType\x12\t\n\x05\x41SYNC\x10\x01\x12\x08\n\x04SYNC\x10\x02\x32X\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\x84\xd8\xca\x89\x01 \x01(\x0b\x32).handsDet.PacketThinnerCalculatorOptionsB\x0c\xa2\x02\thandsDet')
  ,
...
_PACKETTHINNERCALCULATOROPTIONS_THINNERTYPE = _descriptor.EnumDescriptor(
  name='ThinnerType',
  full_name='handsDet.PacketThinnerCalculatorOptions.ThinnerType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_PACKETTHINNERCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.PacketThinnerCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='thinner_type', full_name='handsDet.PacketThinnerCalculatorOptions.thinner_type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='period', full_name='handsDet.PacketThinnerCalculatorOptions.period', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='start_time', full_name='handsDet.PacketThinnerCalculatorOptions.start_time', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='end_time', full_name='handsDet.PacketThinnerCalculatorOptions.end_time', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sync_output_timestamps', full_name='handsDet.PacketThinnerCalculatorOptions.sync_output_timestamps', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update_frame_rate', full_name='handsDet.PacketThinnerCalculatorOptions.update_frame_rate', index=5,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.PacketThinnerCalculatorOptions.ext', index=0,
...
PacketThinnerCalculatorOptions = _reflection.GeneratedProtocolMessageType('PacketThinnerCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.core.packet_thinner_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.PacketThinnerCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_PACKETTHINNERCALCULATOROPTIONS.extensions_by_name['ext'])
