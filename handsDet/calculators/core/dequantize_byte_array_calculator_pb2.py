...
# source: handsDet/calculators/core/dequantize_byte_array_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/core/dequantize_byte_array_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=_b('\242\002\thandsDet'),
  serialized_pb=_b('\nAhandsDet/calculators/core/dequantize_byte_array_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\xc0\x01\n$DequantizeByteArrayCalculatorOptions\x12\x1b\n\x13max_quantized_value\x18\x01 \x01(\x02\x12\x1b\n\x13min_quantized_value\x18\x02 \x01(\x02\x32^\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xb7\xef\xec\x81\x01 \x01(\x0b\x32/.handsDet.DequantizeByteArrayCalculatorOptionsB\x0c\xa2\x02\thandsDet')
  ,
...
_DEQUANTIZEBYTEARRAYCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.DequantizeByteArrayCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='max_quantized_value', full_name='handsDet.DequantizeByteArrayCalculatorOptions.max_quantized_value', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='min_quantized_value', full_name='handsDet.DequantizeByteArrayCalculatorOptions.min_quantized_value', index=1,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.DequantizeByteArrayCalculatorOptions.ext', index=0,
...
DequantizeByteArrayCalculatorOptions = _reflection.GeneratedProtocolMessageType('DequantizeByteArrayCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.core.dequantize_byte_array_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.DequantizeByteArrayCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_DEQUANTIZEBYTEARRAYCALCULATOROPTIONS.extensions_by_name['ext'])
