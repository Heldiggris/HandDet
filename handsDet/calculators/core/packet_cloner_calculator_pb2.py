...
# source: handsDet/calculators/core/packet_cloner_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/core/packet_cloner_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=_b('\242\002\thandsDet'),
  serialized_pb=_b('\n9handsDet/calculators/core/packet_cloner_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\xe9\x01\n\x1dPacketClonerCalculatorOptions\x12\x33\n$output_only_when_all_inputs_received\x18\x01 \x01(\x08:\x05\x66\x61lse\x12;\n,output_packets_only_when_all_inputs_received\x18\x02 \x01(\x08:\x05\x66\x61lse2V\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\x95\xa6\xb8{ \x01(\x0b\x32(.handsDet.PacketClonerCalculatorOptionsB\x0c\xa2\x02\thandsDet')
  ,
...
_PACKETCLONERCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.PacketClonerCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='output_only_when_all_inputs_received', full_name='handsDet.PacketClonerCalculatorOptions.output_only_when_all_inputs_received', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='output_packets_only_when_all_inputs_received', full_name='handsDet.PacketClonerCalculatorOptions.output_packets_only_when_all_inputs_received', index=1,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.PacketClonerCalculatorOptions.ext', index=0,
...
PacketClonerCalculatorOptions = _reflection.GeneratedProtocolMessageType('PacketClonerCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.core.packet_cloner_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.PacketClonerCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_PACKETCLONERCALCULATOROPTIONS.extensions_by_name['ext'])
