...
# source: handsDet/calculators/core/quantize_float_vector_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/core/quantize_float_vector_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=_b('\242\002\tMediaPipe'),
  serialized_pb=_b('\nAhandsDet/calculators/core/quantize_float_vector_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\xbf\x01\n$QuantizeFloatVectorCalculatorOptions\x12\x1b\n\x13max_quantized_value\x18\x01 \x01(\x02\x12\x1b\n\x13min_quantized_value\x18\x02 \x01(\x02\x32]\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xfd\xee\xf3{ \x01(\x0b\x32/.handsDet.QuantizeFloatVectorCalculatorOptionsB\x0c\xa2\x02\tMediaPipe')
  ,
...
_QUANTIZEFLOATVECTORCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.QuantizeFloatVectorCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='max_quantized_value', full_name='handsDet.QuantizeFloatVectorCalculatorOptions.max_quantized_value', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='min_quantized_value', full_name='handsDet.QuantizeFloatVectorCalculatorOptions.min_quantized_value', index=1,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.QuantizeFloatVectorCalculatorOptions.ext', index=0,
...
QuantizeFloatVectorCalculatorOptions = _reflection.GeneratedProtocolMessageType('QuantizeFloatVectorCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.core.quantize_float_vector_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.QuantizeFloatVectorCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_QUANTIZEFLOATVECTORCALCULATOROPTIONS.extensions_by_name['ext'])
