...
# source: handsDet/calculators/tflite/tflite_tensors_to_landmarks_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/tflite/tflite_tensors_to_landmarks_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\nIhandsDet/calculators/tflite/tflite_tensors_to_landmarks_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\xa6\x04\n)TfLiteTensorsToLandmarksCalculatorOptions\x12\x15\n\rnum_landmarks\x18\x01 \x01(\x05\x12\x19\n\x11input_image_width\x18\x02 \x01(\x05\x12\x1a\n\x12input_image_height\x18\x03 \x01(\x05\x12\x1e\n\x0f\x66lip_vertically\x18\x04 \x01(\x08:\x05\x66\x61lse\x12 \n\x11\x66lip_horizontally\x18\x06 \x01(\x08:\x05\x66\x61lse\x12\x16\n\x0bnormalize_z\x18\x05 \x01(\x02:\x01\x31\x12\x64\n\x15visibility_activation\x18\x07 \x01(\x0e\x32?.handsDet.TfLiteTensorsToLandmarksCalculatorOptions.Activation:\x04NONE\x12\x62\n\x13presence_activation\x18\x08 \x01(\x0e\x32?.handsDet.TfLiteTensorsToLandmarksCalculatorOptions.Activation:\x04NONE\"#\n\nActivation\x12\x08\n\x04NONE\x10\x00\x12\x0b\n\x07SIGMOID\x10\x01\x32\x62\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xca\xe0\xdez \x01(\x0b\x32\x34.handsDet.TfLiteTensorsToLandmarksCalculatorOptions')
  ,
...
_TFLITETENSORSTOLANDMARKSCALCULATOROPTIONS_ACTIVATION = _descriptor.EnumDescriptor(
  name='Activation',
  full_name='handsDet.TfLiteTensorsToLandmarksCalculatorOptions.Activation',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_TFLITETENSORSTOLANDMARKSCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.TfLiteTensorsToLandmarksCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='num_landmarks', full_name='handsDet.TfLiteTensorsToLandmarksCalculatorOptions.num_landmarks', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='input_image_width', full_name='handsDet.TfLiteTensorsToLandmarksCalculatorOptions.input_image_width', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='input_image_height', full_name='handsDet.TfLiteTensorsToLandmarksCalculatorOptions.input_image_height', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flip_vertically', full_name='handsDet.TfLiteTensorsToLandmarksCalculatorOptions.flip_vertically', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flip_horizontally', full_name='handsDet.TfLiteTensorsToLandmarksCalculatorOptions.flip_horizontally', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='normalize_z', full_name='handsDet.TfLiteTensorsToLandmarksCalculatorOptions.normalize_z', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='visibility_activation', full_name='handsDet.TfLiteTensorsToLandmarksCalculatorOptions.visibility_activation', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='presence_activation', full_name='handsDet.TfLiteTensorsToLandmarksCalculatorOptions.presence_activation', index=7,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.TfLiteTensorsToLandmarksCalculatorOptions.ext', index=0,
...
TfLiteTensorsToLandmarksCalculatorOptions = _reflection.GeneratedProtocolMessageType('TfLiteTensorsToLandmarksCalculatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.calculators.tflite.tflite_tensors_to_landmarks_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.TfLiteTensorsToLandmarksCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_TFLITETENSORSTOLANDMARKSCALCULATOROPTIONS.extensions_by_name['ext'])
