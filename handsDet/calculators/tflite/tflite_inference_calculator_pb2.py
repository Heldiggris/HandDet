...
# source: handsDet/calculators/tflite/tflite_inference_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/calculators/tflite/tflite_inference_calculator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n>handsDet/calculators/tflite/tflite_inference_calculator.proto\x12\thandsDet\x1a$handsDet/framework/calculator.proto\"\xfb\x08\n TfLiteInferenceCalculatorOptions\x12\x12\n\nmodel_path\x18\x01 \x01(\t\x12\x1a\n\x07use_gpu\x18\x02 \x01(\x08:\x05\x66\x61lseB\x02\x18\x01\x12\x1c\n\tuse_nnapi\x18\x03 \x01(\x08:\x05\x66\x61lseB\x02\x18\x01\x12\x1a\n\x0e\x63pu_num_thread\x18\x04 \x01(\x05:\x02-1\x12\x46\n\x08\x64\x65legate\x18\x05 \x01(\x0b\x32\x34.handsDet.TfLiteInferenceCalculatorOptions.Delegate\x1a\xc9\x06\n\x08\x44\x65legate\x12M\n\x06tflite\x18\x01 \x01(\x0b\x32;.handsDet.TfLiteInferenceCalculatorOptions.Delegate.TfLiteH\x00\x12G\n\x03gpu\x18\x02 \x01(\x0b\x32\x38.handsDet.TfLiteInferenceCalculatorOptions.Delegate.GpuH\x00\x12K\n\x05nnapi\x18\x03 \x01(\x0b\x32:.handsDet.TfLiteInferenceCalculatorOptions.Delegate.NnapiH\x00\x12O\n\x07xnnpack\x18\x04 \x01(\x0b\x32<.handsDet.TfLiteInferenceCalculatorOptions.Delegate.XnnpackH\x00\x1a\x08\n\x06TfLite\x1a\x9b\x03\n\x03Gpu\x12#\n\x14use_advanced_gpu_api\x18\x01 \x01(\x08:\x05\x66\x61lse\x12N\n\x03\x61pi\x18\x04 \x01(\x0e\x32<.handsDet.TfLiteInferenceCalculatorOptions.Delegate.Gpu.Api:\x03\x41NY\x12\"\n\x14\x61llow_precision_loss\x18\x03 \x01(\x08:\x04true\x12\x1a\n\x12\x63\x61\x63hed_kernel_path\x18\x02 \x01(\t\x12g\n\x05usage\x18\x05 \x01(\x0e\x32G.handsDet.TfLiteInferenceCalculatorOptions.Delegate.Gpu.InferenceUsage:\x0fSUSTAINED_SPEED\"&\n\x03\x41pi\x12\x07\n\x03\x41NY\x10\x00\x12\n\n\x06OPENGL\x10\x01\x12\n\n\x06OPENCL\x10\x02\"N\n\x0eInferenceUsage\x12\x0f\n\x0bUNSPECIFIED\x10\x00\x12\x16\n\x12\x46\x41ST_SINGLE_ANSWER\x10\x01\x12\x13\n\x0fSUSTAINED_SPEED\x10\x02\x1a/\n\x05Nnapi\x12\x11\n\tcache_dir\x18\x01 \x01(\t\x12\x13\n\x0bmodel_token\x18\x02 \x01(\t\x1a\"\n\x07Xnnpack\x12\x17\n\x0bnum_threads\x18\x01 \x01(\x05:\x02-1B\n\n\x08\x64\x65legate2Y\n\x03\x65xt\x12\x1c.handsDet.CalculatorOptions\x18\xcd\x8f\xc2o \x01(\x0b\x32+.handsDet.TfLiteInferenceCalculatorOptions')
  ,
...
_TFLITEINFERENCECALCULATOROPTIONS_DELEGATE_GPU_API = _descriptor.EnumDescriptor(
  name='Api',
  full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.Gpu.Api',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_TFLITEINFERENCECALCULATOROPTIONS_DELEGATE_GPU_INFERENCEUSAGE = _descriptor.EnumDescriptor(
  name='InferenceUsage',
  full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.Gpu.InferenceUsage',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_TFLITEINFERENCECALCULATOROPTIONS_DELEGATE_TFLITE = _descriptor.Descriptor(
  name='TfLite',
  full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.TfLite',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_TFLITEINFERENCECALCULATOROPTIONS_DELEGATE_GPU = _descriptor.Descriptor(
  name='Gpu',
  full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.Gpu',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='use_advanced_gpu_api', full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.Gpu.use_advanced_gpu_api', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='api', full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.Gpu.api', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='allow_precision_loss', full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.Gpu.allow_precision_loss', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cached_kernel_path', full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.Gpu.cached_kernel_path', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='usage', full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.Gpu.usage', index=4,
...
_TFLITEINFERENCECALCULATOROPTIONS_DELEGATE_NNAPI = _descriptor.Descriptor(
  name='Nnapi',
  full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.Nnapi',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='cache_dir', full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.Nnapi.cache_dir', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='model_token', full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.Nnapi.model_token', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TFLITEINFERENCECALCULATOROPTIONS_DELEGATE_XNNPACK = _descriptor.Descriptor(
  name='Xnnpack',
  full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.Xnnpack',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='num_threads', full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.Xnnpack.num_threads', index=0,
...
_TFLITEINFERENCECALCULATOROPTIONS_DELEGATE = _descriptor.Descriptor(
  name='Delegate',
  full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tflite', full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.tflite', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='gpu', full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.gpu', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nnapi', full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.nnapi', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='xnnpack', full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.xnnpack', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='delegate', full_name='handsDet.TfLiteInferenceCalculatorOptions.Delegate.delegate',
...
_TFLITEINFERENCECALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.TfLiteInferenceCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='model_path', full_name='handsDet.TfLiteInferenceCalculatorOptions.model_path', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_gpu', full_name='handsDet.TfLiteInferenceCalculatorOptions.use_gpu', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='use_nnapi', full_name='handsDet.TfLiteInferenceCalculatorOptions.use_nnapi', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\030\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cpu_num_thread', full_name='handsDet.TfLiteInferenceCalculatorOptions.cpu_num_thread', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='delegate', full_name='handsDet.TfLiteInferenceCalculatorOptions.delegate', index=4,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.TfLiteInferenceCalculatorOptions.ext', index=0,
...
TfLiteInferenceCalculatorOptions = _reflection.GeneratedProtocolMessageType('TfLiteInferenceCalculatorOptions', (_message.Message,), dict(
  ...
  Delegate = _reflection.GeneratedProtocolMessageType('Delegate', (_message.Message,), dict(
    ...
    TfLite = _reflection.GeneratedProtocolMessageType('TfLite', (_message.Message,), dict(
      ...
      __module__ = 'handsDet.calculators.tflite.tflite_inference_calculator_pb2'
      # @@protoc_insertion_point(class_scope:handsDet.TfLiteInferenceCalculatorOptions.Delegate.TfLite)
      ))
    ,
    ...
    Gpu = _reflection.GeneratedProtocolMessageType('Gpu', (_message.Message,), dict(
      ...
      __module__ = 'handsDet.calculators.tflite.tflite_inference_calculator_pb2'
      # @@protoc_insertion_point(class_scope:handsDet.TfLiteInferenceCalculatorOptions.Delegate.Gpu)
      ))
    ,
    ...
    Nnapi = _reflection.GeneratedProtocolMessageType('Nnapi', (_message.Message,), dict(
      ...
      __module__ = 'handsDet.calculators.tflite.tflite_inference_calculator_pb2'
      # @@protoc_insertion_point(class_scope:handsDet.TfLiteInferenceCalculatorOptions.Delegate.Nnapi)
      ))
    ,
    ...
    Xnnpack = _reflection.GeneratedProtocolMessageType('Xnnpack', (_message.Message,), dict(
      ...
      __module__ = 'handsDet.calculators.tflite.tflite_inference_calculator_pb2'
      # @@protoc_insertion_point(class_scope:handsDet.TfLiteInferenceCalculatorOptions.Delegate.Xnnpack)
      ))
    ,
    DESCRIPTOR = _TFLITEINFERENCECALCULATOROPTIONS_DELEGATE,
    __module__ = 'handsDet.calculators.tflite.tflite_inference_calculator_pb2'
    # @@protoc_insertion_point(class_scope:handsDet.TfLiteInferenceCalculatorOptions.Delegate)
    ))
  ,
  DESCRIPTOR = _TFLITEINFERENCECALCULATOROPTIONS,
  __module__ = 'handsDet.calculators.tflite.tflite_inference_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.TfLiteInferenceCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_TFLITEINFERENCECALCULATOROPTIONS.extensions_by_name['ext'])
