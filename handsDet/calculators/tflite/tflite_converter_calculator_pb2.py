...
# source: handsDet/calculators/tflite/tflite_converter_calculator.proto
...
_TFLITECONVERTERCALCULATOROPTIONS_TENSORFLOATRANGE = _descriptor.Descriptor(
  ...
  full_name='handsDet.TfLiteConverterCalculatorOptions.TensorFloatRange',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min', full_name='handsDet.TfLiteConverterCalculatorOptions.TensorFloatRange.min', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='max', full_name='handsDet.TfLiteConverterCalculatorOptions.TensorFloatRange.max', index=1,
...
_TFLITECONVERTERCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.TfLiteConverterCalculatorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='zero_center', full_name='handsDet.TfLiteConverterCalculatorOptions.zero_center', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_custom_normalization', full_name='handsDet.TfLiteConverterCalculatorOptions.use_custom_normalization', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='custom_div', full_name='handsDet.TfLiteConverterCalculatorOptions.custom_div', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='custom_sub', full_name='handsDet.TfLiteConverterCalculatorOptions.custom_sub', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flip_vertically', full_name='handsDet.TfLiteConverterCalculatorOptions.flip_vertically', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_num_channels', full_name='handsDet.TfLiteConverterCalculatorOptions.max_num_channels', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='row_major_matrix', full_name='handsDet.TfLiteConverterCalculatorOptions.row_major_matrix', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_quantized_tensors', full_name='handsDet.TfLiteConverterCalculatorOptions.use_quantized_tensors', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output_tensor_float_range', full_name='handsDet.TfLiteConverterCalculatorOptions.output_tensor_float_range', index=8,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.TfLiteConverterCalculatorOptions.ext', index=0,
...
TfLiteConverterCalculatorOptions = _reflection.GeneratedProtocolMessageType('TfLiteConverterCalculatorOptions', (_message.Message,), dict(
  ...
  TensorFloatRange = _reflection.GeneratedProtocolMessageType('TensorFloatRange', (_message.Message,), dict(
    ...
    __module__ = 'handsDet.calculators.tflite.tflite_converter_calculator_pb2'
    # @@protoc_insertion_point(class_scope:handsDet.TfLiteConverterCalculatorOptions.TensorFloatRange)
    ))
  ,
  DESCRIPTOR = _TFLITECONVERTERCALCULATOROPTIONS,
  __module__ = 'handsDet.calculators.tflite.tflite_converter_calculator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.TfLiteConverterCalculatorOptions)
  ))
...
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_TFLITECONVERTERCALCULATOROPTIONS.extensions_by_name['ext'])
