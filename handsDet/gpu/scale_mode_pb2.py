...
# source: handsDet/gpu/scale_mode.proto
...
_SCALEMODE_MODE = _descriptor.EnumDescriptor(
  name='Mode',
  full_name='handsDet.ScaleMode.Mode',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
ScaleMode = _reflection.GeneratedProtocolMessageType('ScaleMode', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.gpu.scale_mode_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.ScaleMode)
  ))
