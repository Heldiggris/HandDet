...
# source: handsDet/gpu/gpu_origin.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/gpu/gpu_origin.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n\x1ehandsDet/gpu/gpu_origin.proto\x12\thandsDet\"@\n\tGpuOrigin\"3\n\x04Mode\x12\x0b\n\x07\x44\x45\x46\x41ULT\x10\x00\x12\x10\n\x0c\x43ONVENTIONAL\x10\x01\x12\x0c\n\x08TOP_LEFT\x10\x02')
)
...
_GPUORIGIN_MODE = _descriptor.EnumDescriptor(
  name='Mode',
  full_name='handsDet.GpuOrigin.Mode',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
GpuOrigin = _reflection.GeneratedProtocolMessageType('GpuOrigin', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.gpu.gpu_origin_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.GpuOrigin)
  ))
