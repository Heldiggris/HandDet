...
# source: handsDet/util/tracking/frame_selection_solution_evaluator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='handsDet/util/tracking/frame_selection_solution_evaluator.proto',
  package='handsDet',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n@handsDet/util/tracking/frame_selection_solution_evaluator.proto\x12\thandsDet\"4\n&FrameSelectionSolutionEvaluatorOptions*\n\x08\xa0\x9c\x01\x10\x80\x80\x80\x80\x02\"\x9e\x01\n#FrameSelectionSolutionEvaluatorType\x12\x33\n\nclass_name\x18\x01 \x01(\t:\x1f\x46rameSelectionSolutionEvaluator\x12\x42\n\x07options\x18\x02 \x01(\x0b\x32\x31.handsDet.FrameSelectionSolutionEvaluatorOptions')
)
...
_FRAMESELECTIONSOLUTIONEVALUATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.FrameSelectionSolutionEvaluatorOptions',
  filename=None,
  file=DESCRIPTOR,
...
_FRAMESELECTIONSOLUTIONEVALUATORTYPE = _descriptor.Descriptor(
  ...
  full_name='handsDet.FrameSelectionSolutionEvaluatorType',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='class_name', full_name='handsDet.FrameSelectionSolutionEvaluatorType.class_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='options', full_name='handsDet.FrameSelectionSolutionEvaluatorType.options', index=1,
...
FrameSelectionSolutionEvaluatorOptions = _reflection.GeneratedProtocolMessageType('FrameSelectionSolutionEvaluatorOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.util.tracking.frame_selection_solution_evaluator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.FrameSelectionSolutionEvaluatorOptions)
  ))
...
FrameSelectionSolutionEvaluatorType = _reflection.GeneratedProtocolMessageType('FrameSelectionSolutionEvaluatorType', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.util.tracking.frame_selection_solution_evaluator_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.FrameSelectionSolutionEvaluatorType)
  ))
