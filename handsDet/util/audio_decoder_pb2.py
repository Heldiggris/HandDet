...
# source: handsDet/util/audio_decoder.proto
...
_AUDIOSTREAMOPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.AudioStreamOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='stream_index', full_name='handsDet.AudioStreamOptions.stream_index', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='allow_missing', full_name='handsDet.AudioStreamOptions.allow_missing', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ignore_decode_failures', full_name='handsDet.AudioStreamOptions.ignore_decode_failures', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output_regressing_timestamps', full_name='handsDet.AudioStreamOptions.output_regressing_timestamps', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='correct_pts_for_rollover', full_name='handsDet.AudioStreamOptions.correct_pts_for_rollover', index=4,
...
_AUDIODECODEROPTIONS = _descriptor.Descriptor(
  ...
  full_name='handsDet.AudioDecoderOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='audio_stream', full_name='handsDet.AudioDecoderOptions.audio_stream', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='start_time', full_name='handsDet.AudioDecoderOptions.start_time', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='end_time', full_name='handsDet.AudioDecoderOptions.end_time', index=2,
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='ext', full_name='handsDet.AudioDecoderOptions.ext', index=0,
...
AudioStreamOptions = _reflection.GeneratedProtocolMessageType('AudioStreamOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.util.audio_decoder_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.AudioStreamOptions)
  ))
...
AudioDecoderOptions = _reflection.GeneratedProtocolMessageType('AudioDecoderOptions', (_message.Message,), dict(
  ...
  __module__ = 'handsDet.util.audio_decoder_pb2'
  # @@protoc_insertion_point(class_scope:handsDet.AudioDecoderOptions)
  ))
_sym_db.RegisterMessage(AudioDecoderOptions)

_AUDIODECODEROPTIONS.extensions_by_name['ext'].message_type = _AUDIODECODEROPTIONS
handsDet_dot_framework_dot_calculator__options__pb2.CalculatorOptions.RegisterExtension(_AUDIODECODEROPTIONS.extensions_by_name['ext'])
